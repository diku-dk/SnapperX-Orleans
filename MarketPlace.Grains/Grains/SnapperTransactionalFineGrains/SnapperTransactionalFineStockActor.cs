...
public class SnapperTransactionalFineStockActor : TransactionExecutionGrain, IStockActor
{
    int sellerID;
    ...
    public SnapperTransactionalFineStockActor(ISnapperClusterCache snapperClusterCache, ISnapperReplicaCache snapperReplicaCache, IScheduleManager scheduleManager, ISnapperLoggingHelper log)
        : base(typeof(SnapperTransactionalFineStockActor).FullName, snapperClusterCache, snapperReplicaCache, scheduleManager, log) { }
    ...
    public async Task<object?> AddStock(TransactionContext cxt, object? obj = null)
    {
        ...
        return await RegisterFineReference(cxt, referenceInfo, stock.Item2);
    }
}