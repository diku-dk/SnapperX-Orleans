...
public class SnapperTransactionalFineProductActor : TransactionExecutionGrain, IProductActor
{
    int sellerID;
    ...
    public SnapperTransactionalFineProductActor(ISnapperClusterCache snapperClusterCache, ISnapperReplicaCache snapperReplicaCache, IScheduleManager scheduleManager, ISnapperLoggingHelper log) 
        : base(typeof(SnapperTransactionalFineProductActor).FullName, snapperClusterCache, snapperReplicaCache, scheduleManager, log) { }
